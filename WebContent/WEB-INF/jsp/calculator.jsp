...
.calc{
    padding-right: 12px;}
body{
background:url("http://www.quantum-field-theory.net/wp-content/uploads/2015/04/emc2.jpg");
 background-repeat: no-repeat;
...
<body>
	...
	<div class="row">
		<select name="comboBox" id="comboBox" style=" background-image: url(http://i62.tinypic.com/15xvbd5.png), -webkit-linear-gradient(#FAFAFA, #F4F4F4 40%, #E5E5E5);">
